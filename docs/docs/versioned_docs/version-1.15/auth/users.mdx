...
<figure class="frame">
  <video controls loop autoplay="true" muted>
    <source src="/docs/media/v1/ui/auth/reset-password.mp4" type="video/mp4" />
  </video>
...
<figure class="frame">
  <video controls loop autoplay="true" muted>
    <source src="/docs/media/v1/ui/auth/delete-user.mp4" type="video/mp4" />
  </video>
...
<figure class="frame">
  <img src="/docs/media/v1/ui/auth/disable-user.png" alt="Disable User" />
...
<figure class="frame">
  <video controls loop autoplay="true" muted>
    <source src="/docs/media/v1/ui/auth/user-loft-cluster-roles.mp4" type="video/mp4" />
  </video>
