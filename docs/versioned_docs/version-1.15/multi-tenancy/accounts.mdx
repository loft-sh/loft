---
title: Cluster Access & Accounts
sidebar_label: Cluster Access & Accounts
---
...
<figure class="frame">
  <video controls loop autoplay="true" muted>
    <source src="/docs/media/v1/ui/clusters/delete-account.mp4" type="video/mp4" />
  </video>
...
## Account Templates
Loft provides a CRD called [ClusterAccountTemplate](../auth/account-templates.mdx) which allows you to automatically create cluster accounts for users or tea,s when they are being created or edited.
