...
<figure class="frame">
  <video controls loop autoplay="true" muted>
    <source src="/docs/media/v1/ui/sleep-mode/automatic-account.mp4" type="video/mp4" />
  </video>
...
<figure class="frame">
  <img src="/docs/media/v1/ui/sleep-mode/sleep-mode-hover.png" alt="Display Sleep Mode Information" />
