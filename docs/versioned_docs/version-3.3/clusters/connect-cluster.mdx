...
import PartialClusterConnectCLIExperimental from './_partials/cluster/connect-cli-experimental.mdx'
...
## [Experimental] Connecting a Cluster egress-only
...
<Tabs
  ...
  <TabItem value="cli">
    <PartialClusterConnectCLIExperimental />
  </TabItem>
</Tabs>
