...
<Flow id="impersonate-user">
  <Step>
    In the <NavStep>Users</NavStep> view, hover over the row with the <b>User</b> who you want to impersonate
  </Step>
  <Step>
  ...
  <Step image="">
    Whenver you want to switch back to your regular user, click the <Button>Stop Impersonation</Button> button on the right-hand side of the impersonation banner at the top of the page
  </Step>
</Flow>