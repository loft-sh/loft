...
:::note Syncing labels to the cluster secret of the imported virtual cluster
Loft will sync all labels applied to the virtualclusterinstance to the cluster secret for this virtual cluster in ArgoCD.
Based on this the applicationsets can identify the clusters into which to deploy the applications.
:::
