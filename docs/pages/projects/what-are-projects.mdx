...
containers for virtual resources (spaces and virtual clusters), however, they also also play an important role in
...
Virtual Clusters are added to the Project they can be registered as a destination for Argo CD Apps to be installed.