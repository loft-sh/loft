...
You can find the direct cluster endpoint chart and all available chart options in the [official Loft repo](https://github.com/loft-sh/loft/tree/master/deploy/directclusterendpoint/chart)
