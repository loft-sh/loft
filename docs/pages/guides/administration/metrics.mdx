---
title: Scrape Prometheus Metrics for loft
sidebar_label: Prometheus Metrics
---

Loft exposes several [prometheus style](https://prometheus.io/docs/practices/naming/) metrics that can be scraped. If you want to monitor other applications with loft take a look at the [monitoring guide](../monitoring.mdx) instead.
