---
title: Configure loft to be highly available
...
By default, loft will run in a cluster as a single replica. To understand how loft can be made high available and scaled to multiple replicas, we have to take a look at the core components of loft:
