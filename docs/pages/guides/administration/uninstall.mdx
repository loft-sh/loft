...
The password that was set to the admin user is encrypted and stored in a Kubernetes secret that has the annotation `helm.sh/resource-policy: keep`. This is to really preserve the admin password. To delete this, you have to manually run the following command
