...
:::info 
If the VirtualClusterInstance being deleted is asleep or if the Rancher cluster-agent within the vCluster is not ready & connected to the Rancher Server, then it may take upto 5 minutes for the virtual cluster to be cleared in Rancher.
:::
