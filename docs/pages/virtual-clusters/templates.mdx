...
import PartialVirtualClusterCreateOptionalUI from './_partials/vcluster/create-ui-optional-fields.mdx'
...
<Flow id="create-virtual-cluster-template-version">
    ...
    <Step>
        Click the <NavStep>Virtual Clusters</NavStep> option on the templates pane.
    </Step>
    <Step>
