...
:::info
You can disable syncing of shared secrets by setting the annotation `loft.sh/disable-sync` to `true`. This prevents any user or team from syncing the shared secret to any connected Loft cluster  
:::
