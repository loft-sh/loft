...
You can create as many spaces as your admin has configured for you. You may create spaces in [different Kubernete clusters](#clusters) if your admin has granted you access to more than just one cluster.
