...
Projects are an organizational unit that Loft uses to help logically group resources by team or
...
exposing parameters that users can then select or input at deployment time. Check out more about
