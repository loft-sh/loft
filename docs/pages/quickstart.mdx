...
When Loft CLI asks you how you `How do you want to access loft?`, answer with `via port-forwarding`. We will see at the end of this guide how you can connect a domain and configure SSL.
:::
...
- Much cheaper than "real" Kubernetes clusters (no extra cost for API server + see sleep mode below)
...
To learn more about where to configure these defaults for a user or team, take a look at: [4.3 Users + Accounts](#34-users--accounts)

</TabItem>
</Tabs>

To learn more about how sleep mode works, take a look at the docs page about [sleep mode for namespaces and virtual clusters](./sleep-mode/basics.mdx).


## 4. Give Your Team Access
The features you have seen in this quickstart guide are great, but the idea of Loft is **not** that you as an admin are going to use these features, instead the idea is to let your engineers use these features to get self-service access to Kubernetes. With Loft you can add a pool of clusters and then give engineers access to these clusters.
...
To set up Loft for your team on top of a public or private cloud Kubernetes platform such as GKE, EKS, AKS, RKE, or DOKS, follow the **[Getting Started Guide for setting up Loft for your team](./getting-started/setup.mdx)**.
:::
...
## 5. Cleanup
If you installed Loft to a test cluster and you are now ready to depoy it to a different cluster for your team, use **[this guide to fully remove everything and uninstall Loft](./administration/uninstall.mdx)** from your test cluster with just a few commands.
