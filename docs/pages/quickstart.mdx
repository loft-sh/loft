...
To learn more about [sleep mode and auto-delete for Kubernetes namespaces](./self-service/sleep-mode).

</TabItem>
</Tabs>

To learn more about how sleep mode works, take a look at the docs page about [sleep mode for namespaces and virtual clusters](./self-service/sleep-mode).
