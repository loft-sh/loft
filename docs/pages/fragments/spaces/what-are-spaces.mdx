...
While engineers work with spaces, loft handles the underlying operations on the actual namespaces and ensures the restrictions that admins define for users, e.g. limting the number of spaces/namespaces.
