...
For details about configuring dex for GitHub, take a look at the [dex documentation for GitHub](https://github.com/dexidp/dex/blob/master/Documentation/connectors/github.md).
