...
For details about configuring dex for SAML 2.0, take a look at the [dex documentation for SAML 2.0](https://github.com/dexidp/dex/blob/master/Documentation/connectors/saml.md).
