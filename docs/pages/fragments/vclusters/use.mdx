...
If you need to construct a kube config manually, you'll need to create an [Access Key](../../auth/access-keys.mdx) first. Then create a `kubeconfig.yaml` in the following format:
