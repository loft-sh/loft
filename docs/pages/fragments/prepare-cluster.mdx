...
<Highlight backgroundColor="#3333dd">SaaS edition</Highlight> If you are using the SaaS edition of loft, the API server of the cluster you want to connect must be available on a public IP address (or domain).
:::