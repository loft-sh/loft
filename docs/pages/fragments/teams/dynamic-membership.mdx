Instead of statically assigning users to a team, you can also define "Kubernetes Groups" as team members. This is an advantage if you are [using OpenID Connect for authentication](../../getting-started/auth) because your existing team structure can be easily reflected in loft without the need to manually replicate team memberships.
