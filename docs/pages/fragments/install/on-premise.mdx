...
The idea of loft is giving other engineers access to Kubernetes. A local cluster is great to evaluate and test the features of loft but it will not allow to give other engineers access to a Kubernetes cluster because the loft instance will only be accessible on your computer.
:::
