...
:::note Insecure Clusters
Choose this option if you want to install loft with a self signed certificate or for testing purposes locally.
:::
...
#### Setting hosts file / Configure DNS

Please make sure your specified loft URL is accessible. For local clusters you may need to update your hosts file to access it. For remote clusters make sure you create an A record for the given domain that points to the previously created ingress controller load balancer.
