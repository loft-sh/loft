...
<Tabs
  ...
  values={[
    ...
    { label: 'No Cert-Manager Cluster', value: 'local', },
  ]
}>
<TabItem value="cloud">
...
:::note Self-Signed Certificate Clusters
Choose this option if you want to install loft with a self signed certificate, e.g. in local clusters like minikube or docker-desktop.
:::
