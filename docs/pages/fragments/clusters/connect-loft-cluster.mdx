...
To manage the loft cluster (where loft is running in) using loft, you need to connect it. You can skip this step if you only want to [connect other clusters](#connect-other-clusters) instead. However, it is often useful to connect the loft cluster to manage this cluster using loft although you may not want to make it available to the rest of your team.
