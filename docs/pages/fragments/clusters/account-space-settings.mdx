...
- **Timeout for Automatic Sleep Mode** to [enable automatic sleep mode](../self-service/sleep-mode) after a certain period of inactivity
- **Enforce Templates** to specify [templates](../multi-tenancy/templates) which will be instantiated when creating a space with this account
