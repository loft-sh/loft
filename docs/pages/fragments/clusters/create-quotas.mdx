...
Account quotas can be created for any existing cluster account and as part of the process of updating and [creating cluster accounts](../../clusters/accounts.mdx#create-accounts) when using the UI.
...
<figure class="frame">
  <video controls loop autoplay="true" muted>
    <source src="/docs/media/ui/clusters/create-quota.mp4" type="video/mp4" />
  </video>
