...
```
And this calculation is not even including time for meetings, sick days, holidays etc. That means you can save more than 76% of your cloud infrastructure cost for idle namespaces. There may even be namespace running without any engineer touching them for weeks because we all know how the biggest downside of the cloud is that while it is easy to spin up things, no one ever shuts down anything without being forced to do so.
...
<figure class="frame">
  <video controls loop autoplay="true" muted>
    <source src="/img/ui/spaces/sleep-mode/automatic-account.mp4" type="video/mp4" />
  </video>
...
<figure class="frame">
  <video controls loop autoplay="true" muted>
    <source src="/img/ui/spaces/sleep-mode/automatic-space.mp4" type="video/mp4" />
  </video>
