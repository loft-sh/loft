...
<Flow id="enforce-space-constraints-ui">
  <Step>
...
After following the steps above, all spaces created using the cluster access in step 7 will now enforce these space constraints. You can test this behavior by [impersonating a user](@site/pages/users/impersonation.mdx) that uses this cluster access.
:::