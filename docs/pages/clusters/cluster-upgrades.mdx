...
The platform deploys the proxy-only agent by creating a deployment in the connect cluster's agent's namespace. It additionally reuses the agent's service account and associated RBAC permissions.
